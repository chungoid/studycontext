...
@pytest.mark.parametrize("input_text, expected_output", [
    ("Uh, this is, um, like, a test, you know, so... with extra  spaces.", "this is a test with extra spaces."),
...
@pytest.mark.parametrize("input_text, words_per_segment, expected_segments_count, expected_first_segment_approx_words", [
...
def test_segment_text_by_word_count(input_text, words_per_segment, expected_segments_count, expected_first_segment_approx_words):
